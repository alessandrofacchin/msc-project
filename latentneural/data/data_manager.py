...
class DataManager(object):
    ...
    def store_dataset(dataset: Dict[str, np.ndarray], settings: Dict[str, Any], directory: str, filename: Optional[str]='data.h5'):
        ...
        settings_fname = data_fname.replace('.h5', '_settings.json')
    ...
    @staticmethod
    def load_dataset(directory: str, filename: Optional[str]='data.h5') -> Tuple[Dict[str, np.ndarray], Dict[str, Any]]:
        """Load Dataset
